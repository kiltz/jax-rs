...
public class KommunikationsRestService {
    ...
    /**
     * Testmethode für Überprüfung der Kommunikation curl -i http://127.0.0.1:8080/rs/api/basic/ping?s=test -H
     * "ACCEPT:text/plain" oder curl -i "http://127.0.0.1:8080/rs/api/basic/ping;info=dev?s=test" -H "ACCEPT:text/plain"
     *
     * @param txt
     *            der Query-Param
    ...
    public String pingPlain(@ApiParam(value = "s", required = true) @QueryParam("s") String txt) {
     ...
     * @param ctx
     *            ServletContext um den Pfad zu den Bildern zu holen
